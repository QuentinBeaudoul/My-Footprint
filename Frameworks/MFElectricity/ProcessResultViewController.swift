...
class ProcessResultViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Set up annimation
        let anim = Animation.named("LightBulbAnimation", bundle: Bundle(for: Self.self))
    ...
    private func handleError(_ error: Error) {
        let action = UIAlertAction(title: "retry".localized(bundle: Bundle(for: Self.self)),

...
class ElectricityViewController: UIViewController {
    ...
    let viewModel = ElectricityViewModel()
    ...
    override func viewDidLoad() {
        ...
        publisher.sink { [self] _ in
            print("notification electricity")
            updateHistory()
...
extension ElectricityViewController: UITableViewDataSource {
...
extension ElectricityViewController: UITableViewDelegate {

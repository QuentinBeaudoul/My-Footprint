...
class VehicleViewController: UIViewController {
    ...
    let publisher = NotificationCenter.default.publisher(for: .vehicleHistoryTask)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == R.segue.vehicleViewController.resultSegue.identifier {
...
extension VehicleViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: R.segue.vehicleViewController.resultSegue, sender: nil)
    }
